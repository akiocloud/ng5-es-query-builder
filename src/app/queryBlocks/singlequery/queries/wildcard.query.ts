...
@Component({
	...
	templateUrl: 'wildcard.query.html',
...
export class WildcardQuery implements OnInit, OnChanges {
	...
	public information: any = {
		title: 'Wildcard',
		content: `<span class="description">Returns matches based on a wildcard expression.</span>
					<a class="link" href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-wildcard-query.html#query-dsl-wildcard-query">Read more</a>`
	};
